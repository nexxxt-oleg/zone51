    ...
    <div class="voessen__page-bg" style="background-image: url(./img/bg-zapros.jpg)">
        <div class="container fpad50">
            <ul class="nav voessen__breadcrumbs">
                ...
                <li><span>Запросить предложение</span></li>
            </ul>
            ...
            <div class="voessen__text voessen__text--white fpad15">
                <p>Для того чтобы получить расчет для формирования начальной максимальной цены, заполните следующую
                    форму:</p>
            </div>
            ...
            <form action="">
                <div class="voessen__form voessen__form--pading voessen__form--shadow">
                    <div class="voessen__form__inp-box voessen__form__inp-box--v2">
                        <label for="org" class="form-label">Название организации *</label>
                    ...
                    <div class="voessen__form__inp-box voessen__form__inp-box--v2">
                        <label for="ur-address" class="form-label">Юридический адрес *</label>
                        <input type="text" class="form-control" id="ur-address" name="ur-address" required>
                    </div>
                    <div class="voessen__form__inp-box voessen__form__inp-box--v2">
                        <label for="address" class="form-label">Фактический адрес *</label>
                    ...
                    <div class="voessen__form__inp-box voessen__form__inp-box--v2">
                        <label class="form-label">Прикрепите заявку *</label>
                        <div class="d-flex align-items-center">
                            ...
                            <div id="file-name" class="file-upload__value"></div>
                        </div>
                    </div>
                    <div class="voessen__form__inp-box voessen__form__inp-box--v2">
