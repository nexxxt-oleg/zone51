        ...
        <div class="swiper-container" id="sliderHome">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="voessen__home-slider__item voessen__home-slider__item--sl1">
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-6 col-lg-8">
                                    <div class="voessen__home-slider__item__desc">
                                        <h2 class="voessen__home-slider__item__title">Регуляторы давления и расхода
                                            для чистых газов</h2>
                                        <div class="voessen__home-slider__item__text">
                                            Самый большой в мире выбор первоклассного европейского оборудования для
                                            чистых газов и смесей на их основе — инертных, активных, токсичных,
                                            коррозионных — более 250 регуляторов, газовых панелей, линейных регуляторов,
                                            точек отбора, средств безопасности и комплектующих для газов чистотой до 7.0
                                            в наличии.
                                        </div>
                                        <div class="voessen__home-slider__item__link">
                ...
                <div class="swiper-slide">
                    <div class="voessen__home-slider__item voessen__home-slider__item--sl2">
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-6 col-lg-8">
                                    <div class="voessen__home-slider__item__desc">
        ...
        <div class="row fpad50">
            <div class="col-lg-3 margb30 voessen__right-border">
                <div class="voessen__box-ico">
                    ...
                    <div class="voessen__box-ico__text">Более 5 лет на рынке<br>
                        промышленного газового<br>
                        оборудования
                    </div>
                </div>
            </div>
            <div class="col-lg-3 margb30 voessen__right-border">
                <div class="voessen__box-ico">
                    ...
                    <div class="voessen__box-ico__text">Специальные условия<br>
                        для проектных и<br>
                        монтажных компаний
                    </div>
                </div>
            ...
            <div class="col-lg-3 margb30 voessen__right-border">
                <div class="voessen__box-ico">
                    ...
                    <div class="voessen__box-ico__text">Доставка по всей<br>
                        России, СНГ и<br>
                        ближнему зарубежью
                    </div>
                </div>
            ...
            <div class="col-lg-3 margb30">
                <div class="voessen__box-ico">
                    ...
                    <div class="voessen__box-ico__text">
                        Гарантия 24 месяца<br>
                        + дополнительные<br>
                        опции расширенной<br>
                        гарантии
                    </div>
                </div>
            </div>
